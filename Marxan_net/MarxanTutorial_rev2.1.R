...
source(paste0(sHome,"Marxan_rev2.1.R"))
setwd(sWorkingDir)
...
# Note: if your PUID field is not called "PUID", change that parameter. If you're using more than 2 zones, change that parameter too.
